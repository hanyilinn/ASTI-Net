...
class MCFE_Block_Without_DeformConv(nn.Module):
    def __init__(self, input_channel=1, output_channel=32, cha_num=19):
        super(MCFE_Block_Without_DeformConv, self).__init__()
        self.res1 = ResConv2Block(input_channel, 8)
        self.res2 = ResConv2Block(8, 16)
        self.res3 = ResConv2Block(16, output_channel)
...
class MCFE_Block_Without_Channel_Attention(nn.Module):
    def __init__(self, input_channel=1, output_channel=32, cha_num=19):
        super(MCFE_Block_Without_Channel_Attention, self).__init__()
        self.res1 = ResDeformConv2Block(input_channel, 8)
        self.res2 = ResDeformConv2Block(8, 16)
        self.res3 = ResDeformConv2Block(16, output_channel)
...
class SCFE_Block(nn.Module):
    def __init__(self, eeg_length=1000):
...
class SCFE_Block_Without_MHSA(nn.Module):
    def __init__(self, eeg_length=1000):
        super(SCFE_Block_Without_MHSA, self).__init__()
        # self.feature_extractors = Mamba(eeg_length, 8, 128, device, batch_size)
        # self.feature_extractors = TransformerEXt(eeg_length)
        self.feature_extractors = SimpleCNN(eeg_length)
...
class ASTI_Net_Without_DeformConv(nn.Module):
    def __init__(self, eeg_length=1280, cha_num=19, input_channel=1, fea_channel=32, kernel_size=3, padding=1):
        super(ASTI_Net_Without_DeformConv, self).__init__()
        self.kernel_size = kernel_size
        self.padding = padding
        
        self.mcfe = MCFE_Block_Without_DeformConv(input_channel, fea_channel, cha_num)
...
class ASTI_Net_Without_Channel_Attention(nn.Module):
    def __init__(self, eeg_length=1280, cha_num=19, input_channel=1, fea_channel=32, kernel_size=3, padding=1):
        super(ASTI_Net_Without_Channel_Attention, self).__init__()
        self.kernel_size = kernel_size
        self.padding = padding
        
        self.mcfe = MCFE_Block_Without_Channel_Attention(input_channel, fea_channel, cha_num)
        self.scfe = SCFE_Block(eeg_length)
        self.re = Recon_Block()
...
class ASTI_Net_Without_MHSA(nn.Module):
    def __init__(self, eeg_length=1280, cha_num=19, input_channel=1, fea_channel=32, kernel_size=3, padding=1):
        super(ASTI_Net_Without_MHSA, self).__init__()
        self.kernel_size = kernel_size
        self.padding = padding
        
        self.mcfe = MCFE_Block(input_channel, fea_channel, cha_num)
        self.scfe = SCFE_Block_Without_MHSA(eeg_length)
        self.re = Recon_Block()
...
if __name__ == "__main__":
    ...
    # input = torch.ones(32, 8, 19, 1280)
    # input = torch.ones(32, 1, 1280)
    
    # model = ASTI_Net_Without_DeformConv(cha_num=cha_num)
    # model = ASTI_Net_Without_Channel_Attention(cha_num=cha_num)
    model = ASTI_Net_Without_MHSA(cha_num=cha_num)
